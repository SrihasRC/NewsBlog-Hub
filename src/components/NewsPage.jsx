...
const NewsPage = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-[#111111]">
      <div className="flex flex-col gap-2 mt-2 min-h-[90vh] rounded-lg my-2 mx-3 p-4">
        <div className="max-w-7xl mx-auto w-full">
          ...
          {!showBookmarks && (
            <div className='flex justify-between'>
              <div className="flex mb-6 overflow-x-auto pb-2">
                {categories.map((cat, index) => (
                  <button
                    ...
                    className={`px-4 py-2 whitespace-nowrap text-white cursor-pointer ${
                      category === cat ? 'bg-blue-600' : 'bg-[#252424]'
                    }
              ...
              <div className="relative mb-8 w-90">
                ...
                <input
                  ...
                  className="w-full bg-[#252424] text-white border border-gray-700 rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:border-blue-500"
                />
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredNews.map((article, index) => (
              <div key={index} className="bg-[#1b1b1b] border rounded-lg overflow-hidden">
                {article.urlToImage && (
                  <img 
