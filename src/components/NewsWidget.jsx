    ...
    <div className="bg-[#1E1E1E] rounded-lg p-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <button 
          ...
          className="text-white hover:text-blue-400 text-sm flex items-center gap-1 transition-colors duration-200 cursor-pointer"
        >
      ...
      {news.length > 0 && (
        <div className="relative">
          <div className="relative h-[64.1vh] overflow-hidden rounded-lg">
            <img 
